...
void Renderer::drawSprite(const Actor& actor, const class Texture& tex, Rectangle srcRect, Vector2 origin, Flip flip) const
{
	SDL_Rect dstRect;
...
{
	//Insert the sprite at in the correct place in function of drawOrder.
